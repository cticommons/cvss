...
func TestMetricLookup(t *testing.T) {
	const source = "CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H/E:F"
	...
	base, err := ParseBase("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H")
	if err != nil {
		t.Fatal(err)
	}
...
func TestMetricReplacement(t *testing.T) {
	...
	if err != nil || replaced.String() != "CVSS:3.0/AV:N/AC:H/PR:N/UI:N/S:U/C:H/I:H/A:H/E:F" || vector.String() != source {
		t.Fatalf("replacement = %q, source = %q, error = %v", replaced, vector, err)
	}
	removed, err := replaced.WithMetric(Metric{Name: "E", Value: "X"})
	if err != nil || removed.String() != "CVSS:3.0/AV:N/AC:H/PR:N/UI:N/S:U/C:H/I:H/A:H" {
		t.Fatalf("remove E = %q, %v", removed, err)
	}
	added, err := removed.WithMetric(Metric{Name: "E", Value: "P"})
	if err != nil || added.String() != "CVSS:3.0/AV:N/AC:H/PR:N/UI:N/S:U/C:H/I:H/A:H/E:P" {
...
func TestAppendOptionalMetrics(t *testing.T) {
	vector, err := Parse("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H/E:F/RL:O")
	if err != nil {
		t.Fatal(err)
	}
...
func FuzzUnmarshalJSON(f *testing.F) {
	f.Add([]byte(`"CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H"`))
	f.Add([]byte(`null`))
	f.Fuzz(func(t *testing.T, data []byte) {
		before, err := ParseBase("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H")
		if err != nil {
			t.Fatal(err)
		}
		vector := before
